...
-----------------------------------------------------
ALTER VIEW PROCEDIMIENTO_DETALLE
AS
SELECT QPP_ORDEN AS ORDEN, QPP_CANTIDAD AS CANTIDAD,
P.despro AS PRODUCTO, PCI_CODIGO
FROM QUIROFANO_PROCE_PRODU QP
INNER JOIN SIC3000..Producto P ON QP.CODPRO = P.codpro
WHERE QP.ATE_CODIGO IS NULL AND QPP_ORDEN IS NOT NULL
