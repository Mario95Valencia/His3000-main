...
namespace Core.Datos.Odbc
{
    ...
    public sealed class OdbcHelper
    {
        ...
        /// <summary>
        /// This method is used to attach array's of OdbcParameters to an OdbcCommand.
        /// 
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns no resultset and takes no parameters) against the database specified in 
        ...
        /// </remarks>
        /// <param name="connectionString">a valid connection string for an OdbcConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or PL/SQL command</param>  
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns no resultset) against the database specified in the connection string 
        ...
        {
            //create & open an OdbcConnection, and dispose of it after we are done.
        ...
        /// <summary>
        /// Execute a stored procedure via an OdbcCommand (that returns no resultset) against the database specified in 
        ...
        /// <summary>
        /// Execute an OdbcDbCommand (that returns no resultset and takes no parameters) against the provided OdbcConnection. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns no resultset) against the specified OdbcConnection 
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a stored procedure via an OdbcCommand (that returns no resultset) against the specified OdbcConnection 
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns no resultset and takes no parameters) against the provided OdbcTransaction. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns no resultset) against the specified OdbcTransaction
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a stored procedure via an OdbcCommand (that returns no resultset) against the specified 
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns a resultset and takes no parameters) against the database specified in 
        /// the connection string. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns a resultset) against the database specified in the connection string 
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a stored procedure via an OdbcCommand (that returns a resultset) against the database specified in 
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns a resultset and takes no parameters) against the provided OdbcConnection. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns a resultset) against the specified OdbcConnection 
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a stored procedure via an OdbcCommand (that returns a resultset) against the specified OdbcConnection 
        /// using the provided parameter values.  This method will query the database to discover the parameters for the 
        /// stored procedure (the first time each stored procedure is called), and assign the values based on parameter order.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns a resultset and takes no parameters) against the provided OdbcTransaction. 
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute an OdbcCommand (that returns a resultset) against the specified OdbcTransaction
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a stored procedure via an OdbcCommand (that returns a resultset) against the specified 
        /// OdbcTransaction using the provided parameter values.  This method will query the database to discover the parameters for the 
        /// stored procedure (the first time each stored procedure is called), and assign the values based on parameter order.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// this enum is used to indicate weather the connection was provided by the caller, or created by OdbcHelper, so that
        ...
        /// <summary>
        /// Create and prepare an OdbcCommand, and call ExecuteReader with the appropriate CommandBehavior.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or PL/SQL command</param>  
        /// <returns>an OdbcDataReader containing the resultset generated by the command</returns>
        ...
        {
            //create & open an OdbcbConnection
            ...
            {
                //if we fail to return the OdbcDataReader, we neeed to close the connection ourselves
                cn.Close();
                throw;
            }
        }
