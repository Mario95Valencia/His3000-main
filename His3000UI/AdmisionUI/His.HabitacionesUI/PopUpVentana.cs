    ...
    class PopUpVentana
    {
        ...
        public static void ShowPopUp(double winHeight, double winWidth, ImageSource bgImg, string msgText, Thickness msgPadding)
        {
            try
            {
                ...
                winFadeAni.From = 1.0;
                winFadeAni.To = 1;
                winFadeAni.Duration = new Duration(TimeSpan.FromSeconds(3.1));		//Duration for 1.5 seconds
        ...
        public static void ShowError(double winHeight, double winWidth, ImageSource bgImg, string msgText, Thickness msgPadding)
        {
            try
            {
                //Create a Window
                ...
                popUp.Height = winHeight;
                popUp.Width = winWidth;
                popUp.Left = Screen.PrimaryScreen.Bounds.Width - winWidth-500;
                popUp.Top = Screen.PrimaryScreen.Bounds.Height - winHeight-450;
