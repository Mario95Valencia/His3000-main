...
{
    public partial class frm_BalanceCancelados : Form
    {
        #region Variables
        #endregion

        #region Constructor
        public frm_BalanceCancelados()
        {
            InitializeComponent();
        }
        #endregion
        ...
        #region Eventos
        private void frm_BalancePagosRealizados_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                frm.reporte = "rBalancePagosCancelados";
                if (txt_fecini.Text.Replace(" ", "").Replace("/", "") == string.Empty)
                ...
                //frm.campo4 = "true";
                //frm.campo5 = "Balance de honorarios pagados y transferidos al medico";
