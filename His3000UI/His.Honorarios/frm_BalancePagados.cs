...
{
    public partial class frm_BalancePagados : Form
    {
        #region Variables
        #endregion

        #region Contructor
        public frm_BalancePagados()
        {
            InitializeComponent();
        }
        #endregion
        ...
        #region Eventos
        private void frm_BalancePagados_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            ...
            //    }
            //    frm.campo4 = "true";
            //    frm.campo5 = "BALANCE DE HONORARIOS PAGADOS";
            //    frm.Show();
            ...
            {
                frmReportes frm = new frmReportes();
                frm.reporte = "rBalancePagosRealizados";
                if (txt_fecini.Text.Replace(" ", "").Replace("/", "") == string.Empty)
                    frm.campo1 = "01/01/0001";
                else
                    frm.campo1 = txt_fecini.Text;
                ...
                frm.campo4 = "false";
                frm.campo5 = "BALANCE DE HONORARIOS PENDIENTES DE PAGO COBRADOS POR LA CLINICA";
