...
{
    public partial class ExploradorLocal : Form
    {

        string strDirectorio =  "temp" + "//";  //aqui reemplazar con variables
        ...
        public ExploradorLocal(string x, string y, string nombre_paciente, string ate_codigo)
        {
            InitializeComponent();
            strDirectorio = x;
            strPathGeneral = y;
            txtPaciente.Text = nombre_paciente;
            txtAteCodigo.Text = ate_codigo;
        ...
        private void treeView1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                try
                {
                    ...
                    {
                        //string imagen = treeView1.SelectedNode.Name;
                        string imagen = treeView1.GetNodeAt(e.X, e.Y).Name;
