...
namespace His.Formulario
{
    public partial class Consulta : Form
    {
        ...
        public bool habitacion = false;
        public bool hc = false;
        public bool subsecuentes = false;
        bool emergecia = false;
        public Consulta(string ateCodigo = "", bool _habitacion = false, string HC = "", bool _hc = false)
        {
            InitializeComponent();
        ...
        public void HabilitarBotones(bool buscar, bool guardar, bool editar, bool imprimir, bool receta, bool certificado, bool imagen, bool laboratorio, bool abrir, bool cerrar)
        {
        ...
        private void btnGuarda_Click(object sender, EventArgs e)
        {
            if (Valida())
            {
                if (GuardaFormulario())
                {
                    ...
                    HabilitarBotones(false, false, true, true, true, true, true, true, false, true);
                }
                else
        ...
        public void CargarPacienteExiste() //Cambios Edgar 20210203 antes no rescataba la informacion.
        {
            try
            {
                ...
                if (TPaciente.Rows.Count > 0)
                {
                    ...
                    if (DatosPaciente.Rows.Count > 0)
                    {
                        ...
                        {
                            HabilitarBotones(false, false, false, true, true, true, true, true, true, false);
                            P_Central.Enabled = false;
                        }
                        else
                        {
        ...
        {
            if (!habitacion)
                HabilitarBotones(true, false, false, true, false, false, false, false, false, false);
            if (hc)
            {
                HabilitarBotones(false, false, false, true, false, false, false, false, false, false);
            }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            {
                HabilitarBotones(false, false, false, true, true, true, true, false, false, false);
            ...
            if (Valida())
            {
                if (GuardaFormulario())
                {
                    ...
                    if (validaAtencion.ESC_CODIGO == 1)
                        ...
                        HabilitarBotones(false, false, false, true, true, true, false, false, false, false);
                }
                else
                    MessageBox.Show("Información No Se Guardo Comuniquese Con Sistemas", "HIS3000", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        {
            frm_LaboratorioClinico laboratorio = new frm_LaboratorioClinico(Convert.ToInt64(txtatecodigo.Text.Trim()), true);
            laboratorio.Show();
        }
        ...
        private void btnCerrar_Click(object sender, EventArgs e)
        {
            if (!NegConsultaExterna.CerrarCxe("Form002", Convert.ToInt64(txtatecodigo.Text.Trim())))
            {
                ...
                HabilitarBotones(false, false, true, true, true, true, true, false, false, true);
            }
            else
            {
                MessageBox.Show("Formulario cerrado con exito", "HIS3000", MessageBoxButtons.OK, MessageBoxIcon.Information);
                HabilitarBotones(false, false, false, true, true, true, true, false, true, false);
            }
        }
        ...
        {
            HabilitarBotones(true, false, false, false, false, false, false, false, false, false);
            P_Central.Visible = false;
            P_Datos.Visible = false;
            limpiarCampos();
        }
