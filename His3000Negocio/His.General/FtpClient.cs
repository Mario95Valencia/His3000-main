...
namespace His.General
{
	...
	public class FtpClient
	{
		...
		// defaults
		private string server = Parametros.GeneralPAR.getServidorFTP();
		private string remotePath = ".";
		private string username = Parametros.GeneralPAR.getUsuarioFTP();
        private string password = Parametros.GeneralPAR.getClaveFTP();
		...
		public string[] GetFileList(string mask)
		{
			...
			DateTime timeout = DateTime.Now.AddSeconds(this.timeoutSeconds-9);
